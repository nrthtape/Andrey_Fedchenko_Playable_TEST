...
function resizeGame(){
    ...
    const newWidth = Math.ceil(1390 * scaleFactor);
    const newHeight = Math.ceil(640 * scaleFactor);
    ...
    // scene.width = window.innerHeight * ratio;

    // scene.x = (window.innerWidth - game.width * scale) / 2;
}
